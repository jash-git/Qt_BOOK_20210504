...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_TextHandler_t, stringdata) + ofs \
...
void *TextHandler::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_TextHandler.stringdata))
...
int TextHandler::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: *reinterpret_cast< QString*>(_v) = textTitle(); break;
        default: break;
        }
        _id -= 4;
        ...
        case 3: setTextTitle(*reinterpret_cast< QString*>(_v)); break;
        default: break;
        }
        _id -= 4;
