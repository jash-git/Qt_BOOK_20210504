    ...
    : QDialog(parent)
{
    ...
    clientStatusLabel = new QLabel(tr("用戶端就緒"));
...
void Dialog::updateClientProgress(qint64 numBytes)
{
    ...
    clientStatusLabel->setText(tr("已發送 %1MB")
...
void Dialog::displayError(QAbstractSocket::SocketError socketError)
{
    ...
    QMessageBox::information(this, tr("網絡"),
                             tr("產生以下錯誤: %1.")
                             .arg(tcpClient.errorString()));

    tcpClient.close();
    clientProgressBar->reset();
    clientStatusLabel->setText(tr("用戶端就緒"));
