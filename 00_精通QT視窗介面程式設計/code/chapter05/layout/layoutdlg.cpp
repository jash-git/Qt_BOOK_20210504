...
void CLayoutDlg::init()
{
        ...
        actLStretch0		= lstretchMenu->addAction(tr("¦ùÁY¤ñ¨Ò 0"));
        actLStretch1		= lstretchMenu->addAction(tr("¦ùÁY¤ñ¨Ò 1"));
        actLStretch2		= lstretchMenu->addAction(tr("¦ùÁY¤ñ¨Ò 2"));
        actLStretch4		= lstretchMenu->addAction(tr("¦ùÁY¤ñ¨Ò 4"));
        ...
        actRStretch0		= rstretchMenu->addAction(tr("¦ùÁY¤ñ¨Ò 0"));
        actRStretch1		= rstretchMenu->addAction(tr("¦ùÁY¤ñ¨Ò 1"));
        actRStretch2		= rstretchMenu->addAction(tr("¦ùÁY¤ñ¨Ò 2"));
        actRStretch4		= rstretchMenu->addAction(tr("¦ùÁY¤ñ¨Ò 4"));
