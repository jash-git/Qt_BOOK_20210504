    ...
    : QDialog(parent)
{
    ...
    statusLabel = new QLabel(tr("請首先點擊打開按鈕選擇一個文件！"));
    saveButton = new QPushButton(tr("保存"));
    quitButton = new QPushButton(tr("退出"));
    openButton = new QPushButton (tr("打開"));
        stopButton = new QPushButton(tr("終止"));
...
void Dialog::doCopy()
{
                while(bytesToWrite >0)
                {
                        if(isStop){
                                ...
                                statusLabel->setText(tr("已拷貝 %1MB")
